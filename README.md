...
ssh -i <path_to_pem_file_in_keys_directory> ubuntu@e<aws_server>
```

#### Online-shell
```
http://<aws_server>:5000
```
...
cd ~/Github/Freeida # root repo directory
cd ~/Github/Freeida && npm install # reinstall the modules for the app
...
git clone https://github.com/siddharthgutta/Freeida && cd Freeida
npm install
